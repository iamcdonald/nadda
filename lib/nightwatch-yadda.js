var glob = require('glob-all'),
    ...
    writeSettingsFile = require('./utils/write-settings-file'),
...
function nightwatchYadda (options) {
	...
	try {
		...
		writeSettingsFile(path.resolve(__dirname, 'nightwatch-default.json'),
	                        options.settings,
...
nightwatchYadda.LOCALISATIONS = require('./options/localisation');
nightwatchYadda.BROWSERS = require('./options/browser');
